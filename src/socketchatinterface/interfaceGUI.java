...
public class interfaceGUI extends javax.swing.JFrame {
    ...
    interfaceGUI(String aSdasda) {
        
    }
    private void init(){
        System.out.println("S"+tfNull(jTextField1.getText()));
        if(!tfNull(jTextField1.getText())){
            es = new EchoServer();
    ...
    public void addRequest(){
        jTextArea1.setText(es.getRequest());
    }
    
    private void send(){
        if(!tfNull(jTextField2.getText())){
            es.setResponse(jTextField2.getText());
        }
    }
    
    private boolean tfNull(String txt){
        if(txt.equals("")){
            return true;
        }else{
        return false;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Write the message");
